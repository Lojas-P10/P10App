  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.list}>
        ...
        <Card
          title="Endereços"
          descricao="Livro de endereços"
          icon="map-marker-account"
        />
        <Card
          title="Gerenciamento da conta"
          descricao="Alterar senha, e-mail, telefone..."
          icon="account-box"
        />
        <Card title="Atendimento" descricao="Tire suas dúvidas" icon="phone" />
        <Card
          title="Avaliação"
          descricao="Avalie nosso aplicativo"
          icon="monitor-cellphone-star"
        />
        <Card
          title="Trabalhe nas lojas P10"
          descricao="Oportunidade única"
